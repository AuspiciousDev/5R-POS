...
const Expiration = () => {
  ...
  const getMonthYear1 = new Date().getMonth();
  const getMonthYear2 = new Date().getFullYear();
      ...
      >
        <Box className="contents-header">
          <Typography
            ...
            fontWeight="700"
          >
            {format(new Date(), "MMMM")} Expiration
          </Typography>
        </Box>
        <Box
          sx={{
            ...
            rows={
              inventory
                ? inventory.filter((filter) => {
                    return (
                      filter.status === true &&
                      filter.expiredOn !== "n/a" &&
                      format(new Date(filter.expiredOn), "MM yyyy") ===
